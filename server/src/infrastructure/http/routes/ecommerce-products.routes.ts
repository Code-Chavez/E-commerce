...
router.get(
  '/ecommerce/genders',
  genderController.getActive.bind(genderController)
);
router.get(
  '/ecommerce/attributes',
  attributeController.getActiveAttributes.bind(attributeController)
);
router.get(
...
router.get(
  '/ecommerce/products/best-sellers',
  bestSellersController.getBestSellers.bind(bestSellersController)
);
router.get(
  '/ecommerce/products/on-sale',
  onSaleController.getOnSale.bind(onSaleController)
);

// GET /api/v1/ecommerce/products/:id/related — HU-093 Cross-selling (antes del :slug para evitar conflictos)
router.get(
  '/ecommerce/products/:id/related',
  relatedController.getRelated.bind(relatedController)
);

// GET /api/v1/ecommerce/products/:slug — Detalle de un producto por slug (Público de e-commerce)
router.get(
  '/ecommerce/products/:slug',
  searchController.getDetail.bind(searchController)
);
