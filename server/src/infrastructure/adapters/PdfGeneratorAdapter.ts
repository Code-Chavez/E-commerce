  ...
  async generateCreditNotePdf(data: {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        // Usage Note
        doc.fillColor('#3F3F3F').fontSize(11).text('TÉRMINOS DE USO', 300, 155);
        ...
        doc.moveTo(50, 245).lineTo(545, 245).strokeColor('#D9D9D2').stroke();
        ...
        doc.moveTo(50, 270).lineTo(545, 270).strokeColor('#3F3F3F').stroke();
        ...
        for (const item of data.items) {
          ...
          doc
            ...
            .text(`S/. ${price.toFixed(2)}`, 380, currentY, {
              width: 70,
              align: 'right',
            })
            .text(`S/. ${total.toFixed(2)}`, 465, currentY, {
              width: 80,
              align: 'right',
            });
        ...
        doc
          ...
          .text(`S/. ${data.amount.toFixed(2)}`, 465, currentY, {
            width: 80,
            align: 'right',
          });
        ...
        doc
          ...
          .text(
            'Este es un comprobante digital emitido por E-Commerce.',
            50,
            765,
            { align: 'center' }
          );
